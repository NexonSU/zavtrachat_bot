...
func main() {
	...
	commandList := []commandList{
		...
		{gotgbot.BotCommand{Command: "redemption", Description: "возродить всех недавних юзеров"}, Redemption},
		{gotgbot.BotCommand{Command: "massrevive", Description: "возродить всех недавних юзеров"}, Redemption},
		{gotgbot.BotCommand{Command: "megarevive", Description: "возродить всех недавних юзеров"}, Redemption},
		...
		{gotgbot.BotCommand{Command: "kilomlem", Description: "сильно укусить кого-нибудь"}, Kill},
		{gotgbot.BotCommand{Command: "megabite", Description: "очень сильно укусить кого-нибудь"}, Kill},
		{gotgbot.BotCommand{Command: "megamlem", Description: "очень сильно укусить кого-нибудь"}, Kill},
