...
func DelBet(bot *gotgbot.Bot, context *ext.Context) error {
	...
	if len(context.Args()) < 3 {
		return Reply("Пример использования: <code>/delbet 30.06.2023 ставлю жопу, что TESVI будет говном</code>", *context)
	}
